...
class SiteAuditCheckCodebasePhpCodeSniffer extends SiteAuditCheckAbstract {
  ...
  public function getResultInfo() {
    ...
    return dt('Cannot find code_sniffer standards for drupal inside ' . $this->registry['phpcs_standard']);
  }
    ...
    if (drush_get_option('html') == TRUE) {
      ...
      foreach ($this->registry['phpcs_out'] as $filename => $violations) {
        ...
        foreach ($violations as $violation) {
          ...
          $ret_val .= "<tr><td>$line, $column</td><td>$severity</td><td>$violation</td></tr>";
        }
      }
      $ret_val .= '</table>';
    }
      ...
      foreach ($this->registry['phpcs_out'] as $filename => $violations) {
        ...
        foreach ($violations as $violation) {
          ...
          $ret_val .= "$line, $column : $severity - $action";
        }
      }
    }
    return $ret_val;
